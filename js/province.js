...
function showPro(){
	 ...
	 if (val != null) {
	  ...
	  function selectCountry(obj) {
		  ...
		  function getaddress() {
			    var address = province[current_prov].name + "|" + province[current_prov]['city'][current_city].name + "|" + province[current_prov]['city'][current_city]['districtAndCounty'][current_country]+"|";
			    return address;
		  }
